...
class StripeServiceTest {
    ...
    void itShouldChargeCard() throws StripeException {
        ...
        assertThat(requestMap).containsEntry("amount", amount);
        assertThat(requestMap).containsEntry("currency", currency);
        assertThat(requestMap).containsEntry("source", cardSource);
        assertThat(requestMap).containsEntry("description", description);
